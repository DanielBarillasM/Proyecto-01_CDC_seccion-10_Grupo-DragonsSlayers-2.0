...
La versión documentada reporta \textbf{102 pruebas aprobadas en 5 suites}, generación
...
is validated by 102 automated tests distributed across five suites. This document
...
\midrule
\textbf{Total} & \textbf{102} & cinco suites aprobadas \\
\bottomrule
\end{tabularx}
...
directamente desde los archivos \archivo{.cps} mediante \codigo{?raw}. La reducción
de 105 a 102 pruebas elimina una comprobación redundante, no cobertura funcional de
...
Criterio & Evidencia \\
\midrule
Corrección & reglas y 102 pruebas \\
...
Casos de prueba & cinco suites y ejemplos & \estado{Cubierto} \\
...
Los ejemplos y 102 pruebas convierten los requisitos en evidencia repetible.
...
\begin{enumerate}
  ...
  \item Las 102 pruebas y los archivos de demostración permiten repetir la evidencia
...
\codigo{npm test} & ejecutar 102 pruebas \\
