...
\begin{titlepage}
  ...
  \IfFileExists{../../presentation/assets/compiler-pipeline-hero.png}{
    \includegraphics[width=0.84\textwidth]{../../presentation/assets/compiler-pipeline-hero.png}
  }{
...
La versión documentada reporta \textbf{105 pruebas aprobadas en 6 suites}, generación
reproducible de ANTLR, comprobación TypeScript y build de producción exitosos. El
...
is validated by 105 automated tests distributed across six suites. This document
...
electron-builder & 26 & portable e instalador \\
...
\section{Recursos visuales existentes}

\begin{figure}[H]
  \centering
  \IfFileExists{../../presentation/assets/compiler-pipeline-hero.png}{
    \includegraphics[width=0.9\textwidth]{../../presentation/assets/compiler-pipeline-hero.png}
  }{\fbox{\parbox{0.85\textwidth}{Imagen del pipeline no encontrada.}}}
  \caption{Ilustración existente del pipeline de Compiscript.}
...
\begin{figure}[H]
  ...
  \caption{Ilustración existente de ámbitos y tabla de símbolos.}
...
\begin{picture}(150,69)
  ...
  \put(5,40){\framebox(31,8){Header}}
  \put(60,40){\framebox(31,8){ProjectTabs}}
  \put(112,40){\framebox(34,8){CompilerGuide}}
  \put(4,22){\framebox(32,8){InputEditor}}
  \put(58,22){\framebox(35,8){ResultStatus}}
  \put(105,22){\framebox(43,8){ResultExplorer}}
  \put(50,3){\framebox(30,8){Símbolos}}
  \put(84,3){\framebox(30,8){Scopes}}
  \put(118,3){\framebox(30,8){Árboles}}
  \put(67,57){\vector(-3,-1){35}}
  \put(75,57){\vector(0,-1){9}}
  \put(83,57){\vector(3,-1){33}}
  \put(68,40){\vector(-2,-1){35}}
  \put(75,40){\vector(0,-1){10}}
  \put(82,40){\vector(2,-1){29}}
  \put(119,22){\vector(-2,-1){39}}
  \put(126,22){\vector(-1,-1){20}}
  \put(133,22){\vector(0,-1){11}}
\end{picture}
\caption{Jerarquía simplificada de componentes React.}
\label{fig:ui-components}
\end{figure}

\section{Editor y carga de archivos}

\archivo{InputEditor} permite seleccionar \archivo{.cps}, editar, limpiar, copiar y
descargar. El control limita visualmente la extensión y valida de nuevo antes de leer
el archivo. Se muestran nombre, cantidad de líneas, caracteres, posición del cursor y
estado de preparación.

\section{Navegación por fases}

\archivo{ProjectTabs} separa lexer, parser, semántica y documentación. Esto permite
estudiar tokenización sin crear el parser, observar el CST sin ejecutar semántica o
inspeccionar el pipeline completo.

\section{Explorador semántico}

\archivo{SemanticResultExplorer} organiza resultados en:
...
\codigo{npm run exe:installer} un instalador NSIS, ambos Windows x64. Los artefactos
quedan en \archivo{release}. El usuario final no necesita Node ni Java; Java solo
interviene al regenerar ANTLR.
...
\archivo{analyze.compiscript.test.ts} & 14 & lexer, parser y pipeline \\
\archivo{rubric.examples.test.ts} & 8 & matriz léxica/sintáctica heredada \\
\archivo{examples.sync.test.ts} & 3 & sincronización de ejemplos integrados \\
\archivo{projectExamples.test.ts} & 8 & archivos semánticos de demostración \\
\midrule
\textbf{Total} & \textbf{105} & seis suites aprobadas \\
\bottomrule
\end{tabularx}
...
Criterio & Evidencia \\
\midrule
Corrección & reglas y 105 pruebas \\
...
Casos de prueba & seis suites y ejemplos & \estado{Cubierto} \\
...
UI & resultados extensos competían con editor & workbench y pestañas \\
...
\begin{itemize}
  ...
  \item Windows x64 para los ejecutables configurados;
...
Los ejemplos y 105 pruebas convierten los requisitos en evidencia repetible.
...
\begin{itemize}
  ...
  \item el empaquetado configurado se limita a Windows x64;
...
\begin{enumerate}
  ...
  \item Las 105 pruebas y los archivos de demostración permiten repetir la evidencia
...
\archivo{src/ui/components/InputEditor.tsx} & editor y archivos \\
\archivo{src/ui/components/SemanticResultExplorer.tsx} & navegación de resultados \\
...
\codigo{npm test} & ejecutar 105 pruebas \\
...
\codigo{npm run exe:portable} & crear portable x64 \\
